    ...
    <body class="container">
        ...
        <div class="jumbotron mt-3">
            ...
            <div class='text-center'>    
                ...
                <button type="button" class="btn btn-success" onclick="window.location='{{ route('updateView') }}'">Update Location</button>
                <button type="button" class="btn btn-warning" onclick="window.location='{{ route('tradeView') }}'">Trade Items</button>
                <button type="button" class="btn btn-danger" onclick="window.location='{{ route('genInfo') }}'">Reports</button>
            </div>
        </div>
